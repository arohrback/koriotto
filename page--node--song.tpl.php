  ...
  <div id="slideshow">
    <div id="slides">
      <div class="slides_container">
        <img src="<?php print base_path() . drupal_get_path('theme', 'wetsip') . '/images/andy_winkyworms.jpg'; ?>"/>
        <img src="<?php print base_path() . drupal_get_path('theme', 'wetsip') . '/images/curtains_up_hidden_acres.jpg'; ?>"/>
        <img src="<?php print base_path() . drupal_get_path('theme', 'wetsip') . '/images/megan_goldie.jpg'; ?>"/>
        <img src="<?php print base_path() . drupal_get_path('theme', 'wetsip') . '/images/ryan_eibc.jpg'; ?>"/>
      </div>
